        ...
        <div class="row">
            <div class="offset-1 col-10">
                ...
                <ul class="nav nav-tabs justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('profile-show', $user->id) }}">Community posts</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('profile-show-sub', $user->id) }}">Challenge submissions</a>
                    </li>
                </ul>

                @forelse($norm_post as $post)
                <div class="card mt-3 mb-3" style="border-radius: 2rem; box-shadow: 7px 7px 15px -10px rgba(0,0,0,0.48);">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <a style="text-decoration: none; color:black;" href="{{ route('post-view', $post->id) }}">{{ $post->content }}</a>
                            </div>
                            <div>
